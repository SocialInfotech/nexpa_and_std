 ...
 */
public class MAMExtensionProviderWith extends DataPacketProvider.PacketExtensionProvider {

    private OnTest mCallback;

    public void addOnParseListener(OnTest callback) {
            ...
            switch (parser.getEventType()) {
                ...
                case XmlPullParser.END_TAG:
                    ...
                    switch (parser.getName()) {
                        ...
                        case "fin":
                            if(mCallback!=null)mCallback.onTest();
                            //if(mCallback!=null)mCallback.onParseComplete(msgs, first, last, count);
                            break;
